...
function ArticleManage() {
  ...
  const handleBlock = (id) => {
    instance.get(`/admin/approveArticle/${id}`).then(() => {
      setArticles(
  ...
  return (
    <>
    <h1 className="text-2xl font-bold mb-4"><u>Articles</u></h1>
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        <thead className="text-xs text-gray-400 uppercase bg-gray-900">            <tr>
            ...
            {articles.map((article) => {
              return (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-gray-300 font-semibold">{article.title}</td>
                  <td className="px-6 py-4">{new Date(article.createdDate).toLocaleDateString()}</td>
